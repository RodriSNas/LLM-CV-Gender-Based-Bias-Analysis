...
RAW_OUTPUT      = OUTPUT_DIR / "raw_responses_openai_new_scoring_.jsonl"
SUMMARY_OUTPUT  = OUTPUT_DIR / "scores_summary_openai_new_scoring_scale_s_fair.csv"
...
However, there is no mention of CRM tools such as Salesforce, no explicit inbound lead handling, no collaboration with marketing or operations teams, and no experience managing a sales team, all of which are explicit JD requirements."
